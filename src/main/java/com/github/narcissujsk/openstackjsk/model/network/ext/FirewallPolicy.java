...
import com.github.narcissujsk.openstackjsk.model.network.ext.builder.FirewallPolicyBuilder;
...
public interface FirewallPolicy extends ModelEntity, Buildable<FirewallPolicyBuilder> {
	...
	/**
	 * @see com.github.narcissujsk.openstackjsk.model.network.ext.FirewallRule

...
import com.github.narcissujsk.openstackjsk.model.common.*;
import com.github.narcissujsk.openstackjsk.model.heat.Resource;
import com.github.narcissujsk.openstackjsk.model.heat.ResourceHealth;
import com.github.narcissujsk.openstackjsk.openstack.heat.domain.HeatResource;
import com.github.narcissujsk.openstackjsk.openstack.heat.domain.HeatResource.Resources;
...
public class ResourcesServiceImpl extends BaseHeatServices implements ResourcesService {
	...
	public List<? extends Resource> list(String stackNameOrId, int depth) {
		...
		return get(Resources.class, uri("/stacks/%s/resources", stackNameOrId))

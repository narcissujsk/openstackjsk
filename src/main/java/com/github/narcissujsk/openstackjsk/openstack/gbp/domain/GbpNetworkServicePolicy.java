...
public class GbpNetworkServicePolicy implements NetworkServicePolicy {
    ...
    private List<com.github.narcissujsk.openstackjsk.openstack.gbp.domain.GbpNetworkServiceParams> gbpNetworkServiceParamsList;
    ...
    public List<com.github.narcissujsk.openstackjsk.openstack.gbp.domain.GbpNetworkServiceParams> getGbpNetworkServiceParamsList() {
        return gbpNetworkServiceParamsList;
    }

    public void setGbpNetworkServiceParamsList(List<com.github.narcissujsk.openstackjsk.openstack.gbp.domain.GbpNetworkServiceParams> gbpNetworkServiceParamsList) {
